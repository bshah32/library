				...
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach items="${librarianList}" var="librarian">
							...
							<tr>
								<td>${librarian.branch_id}</td>
								<td>${librarian.branch_name}</td>
								<td>${librarian.address}</td>
								<td><a
									href='${pageContext.request.contextPath}/admin/info/${librarian.branch_id}'>
										<i class="icon-edit"></i>
								</a> &nbsp; <a
									href='${pageContext.request.contextPath}/admin/delete/${librarian.branch_id}'>
