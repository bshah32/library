						...
						<c:forEach items="${book_loans_model}" var="bookLoanModel">
							...
							<tr>
								...
								<%-- <a
									...
									href='${pageContext.request.contextPath}/book/onSelectedBookCheckin/${bookLoanModel.book_id}/${bookLoanModel.branch_id}/${bookLoanModel.card_no}'>
