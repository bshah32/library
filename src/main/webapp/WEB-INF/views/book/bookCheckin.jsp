...
<body>
	...
	<div class="container">
					...
					<div class="container">
						<ul class="nav">
							...
							<li><a href='${pageContext.request.contextPath}/book/bookavailability'>Book
									Availability</a></li>
							<li class="active"><a href='${pageContext.request.contextPath}/book/bookcheckin'>Book
									Checkin</a></li>
		...
		<div class="row-fluid">
			<div class="span12">
				<form:form method="post" modelAttribute="book_loans_model"
					action="${pageContext.request.contextPath}/book/onBookCheckin"
